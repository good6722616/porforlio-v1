  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Charles Zhang - Software Developer Portfolio. Full-stack developer specializing in React.js, Next.js, Node.js, and cloud technologies."
        />
        <link
        ...
        <title>Charles Zhang - Software Developer Portfolio</title>
      </Head>
      <body>
        <Main />
        <NextScript />
